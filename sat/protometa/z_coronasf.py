...
instruments = {
    "skl": [skl, ( # mkl, skl, song
        ...
        ("e0519", (("electron", 0.5, None), ("proton", 1, 9), "MeV", 1, "")), # MKL
        # MKL смесовый канал электроны 0,5 МэВ + 
        # протоны – каких именно энергий протоны не знаю, тут написано что 1,9 МэВ,
        # у меня в базе – 9 МэВ – придется разбираться
        ...
        ("p142",   ("proton",  14,  26,   "MeV", 1, "")),      # MKL It must be called p1426
        ("p265",   ("proton",  26,  50,   "MeV", 1, "")),      # MKL

        ("p509",   ("proton",  50,  90,   "MeV", 1, "")),      # MKL ==
        ("p5090",  ("proton",  50,  90,   "MeV", 1, "")),      # MKL ==

        ("p200300",("proton", 200, 300,   "MeV", 1, "")),      # SONG
        ...
        # 1 это отметка формального сбоя по контрольной сумме,
        # по опыту КОРОНАС- И она почти ничего не значит
    )],
#    "difos":  [difos, ()],
#    "spirit": [spirit, ()],
#    "resik":  [resik, ()],
